...
import dev.minn.jda.ktx.interactions.components.find
...
class InlineInteractiveMessage(
     ...
     */
    fun canInteract(e: GenericComponentInteractionCreateEvent) =
        components.toDefaultComponentTree().find<ActionComponent> { it.customId == e.componentId } != null && filter(e)
