...
object Localization : LocalizationFunction {
    ...
    private object UTF8Control : ResourceBundle.Control() {
        override fun newBundle(
            ...
            return stream.use { InputStreamReader(it, StandardCharsets.UTF_8).use(::PropertyResourceBundle) }
        }
    }
    ...
    fun init(commandBundle: String, generalBundle: String) {
        ...
        commandBundles = locales
            ...
            .map { it to ResourceBundle.getBundle(commandBundle, Locale.forLanguageTag(it.locale), UTF8Control) }
        generalBundles = locales.associateWith { ResourceBundle.getBundle(generalBundle, Locale.forLanguageTag(it.locale), UTF8Control) }
    }
